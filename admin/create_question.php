...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $question = normalize_input($_POST['question']);
    $a = normalize_input($_POST['choice_a']);
    $b = normalize_input($_POST['choice_b']);
    $c = normalize_input($_POST['choice_c']);
    $d = normalize_input($_POST['choice_d']);
